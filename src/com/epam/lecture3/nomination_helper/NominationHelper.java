...
public class NominationHelper {
    ...
    public static void nominate(Nominator nominator, Nominee nominee, Award award, NominateType method) {
        switch (method) {
            case Task1:
                doTask1(nominator, nominee, award);
                break;
            case Task2:
                doTask2(nominator, nominee, award);
                break;
            case Task3:
                doTask3(nominator, nominee, award);
                break;
            case Task4:
                doTask4(nominator, nominee, award);
                break;
            case Task5:
                doTask5(nominator, nominee, award);
                break;
            case Lecture3:
    ...
    private static void doTask1(Nominator nominator, Nominee nominee, Award award) {
        // task 3.1
        int quantitySum1 = 0;
        int amountSum1 = 0;
    ...
    private static void doTask2(Nominator nominator, Nominee nominee, Award award) {
        // task 3.2
        int quantitySum2 = 0;
        int amountSum2 = 0;
        do {
    ...
    private static void doTask3(Nominator nominator, Nominee nominee, Award award) {
        // task 3.3
        int quantitySum3 = 0;
        int amountSum3 = 0;
        for (; ; ) {
    ...
    private static void doTask4(Nominator nominator, Nominee nominee, Award award) {
        // task 3.4
        int quantitySum4 = 0;
        int amountSum4 = 0;
    ...
    private static void doTask5(Nominator nominator, Nominee nominee, Award award) {
